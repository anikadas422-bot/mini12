  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<AuthProvider>(
      builder: (context, authProvider, child) {
         ...
         final linkedIds = linkedElderly.map((e) => e.id).toList();
                              ...
                              children: [
                                 Padding(
                                   ...
                                   child: Column(
                                     ...
                                     children: [
                                       Text("${l10n.condition}: ${p['conditions'] ?? l10n.notAvailable}"), 
                                       Text("${l10n.medicines}: ${p['medicines'] ?? l10n.notAvailable}"), 
                                       ...
                                       if (isPending)
                                         Row(
                                           ...
                                           children: [
                                              ElevatedButton(
                                                onPressed: () => Provider.of<AuthProvider>(context, listen: false).updateHospitalAccess(p['uid'], 'approved'),
                                                style: ElevatedButton.styleFrom(backgroundColor: Colors.green),
                                                child: Text(l10n.approve),
                                              ),
                                              ElevatedButton(
                                                onPressed: () => Provider.of<AuthProvider>(context, listen: false).updateHospitalAccess(p['uid'], 'rejected'),
...
class _AppointmentStatusBox extends StatelessWidget {
  const _AppointmentStatusBox();
                 ...
                 child: Column(
                   ...
                   children: [
                     ...
                     Row(
                       ...
                       children: [
                         TextButton(
                           onPressed: () => appointmentService.updateStatus(apt.id, AppointmentStatus.rejected, staffId: user?.id),
