  ...
  Future<void> _handlePress() async {
    ...
    final confirm = await showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: const Text("Are you sure you want to send an SOS alert? This will share your live location with staff."),
        actions: [
          TextButton(
      ...
      try {
        ...
        if (mounted) {
           ScaffoldMessenger.of(context).showSnackBar(
             const SnackBar(content: Text("SOS Alert Sent! Location is being shared."), backgroundColor: Colors.red),
           );
        }
      } catch (e) {
        if (mounted) {
